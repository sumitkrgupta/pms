        ...
        <div class="collapse navbar-collapse" id="Navbar">
            <ul class="navbar-nav mr-auto" id="nav">
                <li class='nav-item mr-3'>
                    <a class='nav-link' href='reviews.php'><i class="fas fa-align-right"></i>&emsp;AddLinks</a>
                </li>
            </ul>
           ...
           <!--  <span class="navbar-nav mr-3">
			...
			<span class="d-none d-sm-inline text-white"><i class="fas fa-user"></i>&nbsp;<?php echo $_SESSION['adminname']; ?></span>
			&emsp;
