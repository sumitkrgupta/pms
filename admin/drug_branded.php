...
<!--################################################################################################################-->	
		...
		<div class="col-lg-12 m-auto"> 
			<ol class="breadcrumb">
			  	...
			  	<li class="active">Branded Medicine</li>
			</ol>
			<div class="tbl-content">			
				<table id="drug_catTable"class="table table-sm table table-hover">
					<!--table Heading-->
		...
		<script type="text/javascript">				
			...
			let drug_catTable=document.getElementById('drug_catTable');
			let tr = drug_catTable.getElementsByTagName("tr");
